...
use crate::{div_2_pow_n, rem_2_pow_n, urem_2_pow_n};
...
pub struct VmOccupiedEntry<'a, const D: usize, T> {
    hm_entry: OccupiedEntry<'a, IVec3, usize, FxBuildHasher>,
    slab: &'a mut Slab<Chunk<D, T>>,
    pos: UVec3,
}
...
pub struct VmVacantEntry<'a, const D: usize, T> {
    hm_entry: Entry<'a, IVec3, usize, FxBuildHasher>,
    slab: &'a mut Slab<Chunk<D, T>>,
    pos: UVec3,
}
