...
fn compute_mipmap(
    ...
    let color = (
        textureLoad(previous_mip_level, 2u * id.xy + offset.xx, texture_index, 0) +
        textureLoad(previous_mip_level, 2u * id.xy + offset.xy, texture_index, 0) +
        textureLoad(previous_mip_level, 2u * id.xy + offset.yx, texture_index, 0) +
        textureLoad(previous_mip_level, 2u * id.xy + offset.yy, texture_index, 0)
    ) * 0.25;
