...
fn layered_chunk_storage_write(c: &mut Criterion) {
...
fn layered_chunk_storage_read(c: &mut Criterion) {
    let mut storage = LayeredChunkStorage::<u32>::new();
    ...
    let storage = LayeredChunkStorage::<u32>::new();
...
criterion_group!(
    benches,
    layered_chunk_storage_write,
    layered_chunk_storage_read
);
